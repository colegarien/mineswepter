...
describe('angularjs homepage todo list', function() {
  it('should add a todo using custom commands', function(browser) {
    ...
    expect(taskEl).text.toEqual('what is nightwatch?');

    // find our task in the list and mark it as done
    const inputElement = element(elements[2]).findElement('input');
